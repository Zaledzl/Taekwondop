...
//起名 蓝牙低功耗服务
public class BluetoothLeServicep extends Service {

    //Class.getName()：以String的形式，返回Class对象的“实体”名称；
    //Class.getSimpleName()：获取源代码中给出的“底层类”简称。
    private final static String TAG = BluetoothLeServicep.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        BluetoothLeServicep getService() {
            return BluetoothLeServicep.this;
        }
    }
